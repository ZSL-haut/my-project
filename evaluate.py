...
class Config:
    test_data_root = './datas/datas1/test'
    ...
    feature_dim = 512
    # 结果保存路径
    results_save_dir = './results/result1/evaluate'
    # 训练好的模型权重路径
    best_model_paths = {
...
if __name__ == "__main__":
    ...
    log_files = {
        'ConvNeXt_Tiny': './results/result1/convnext_tiny/training_log_convnext_tiny.csv',
        'EfficientNet_B0': './results/result1/efficientnet_b0/training_log_efficientnet_b0.csv',
        'ResNet34': './results/result1/ResNet34/training_log_resnet34.csv',
        'ResNet50': './results/result1/ResNet50/training_log_resnet50.csv',
        'ViT_Base_Patch16_224': './results/result1/vit_base_patch16_224/training_log_vit_base_patch16_224.csv'
    }
